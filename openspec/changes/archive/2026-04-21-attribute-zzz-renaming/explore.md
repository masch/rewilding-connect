## Exploration: Entity Attribute Renaming (zzz_ prefix)
...
1. **Full Prefixing (Recursive/Global)**
   - **Description**: Rename *every* property in entities to `zzz_<original_name>`. This includes Primary Keys, Foreign Keys, and metadata fields.
...
2. **Selective Prefixing (Business Logic Only)**
   ...
   - **Cons**: Doesn't fully meet the user's "Scream Refactor" goal of identifying *every* used attribute.
   - **Effort**: Medium.
